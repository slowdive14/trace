...
const CATEGORY_KEYWORDS: Record<ExpenseCategory, string[]> = {
    ...
    '통신': ['통신비', '요금', '휴대폰', '인터넷', '구독', '넷플릭스', '유튜브', '멜론', '스포티파이'],
    '교육': ['학원', '강의', '수업', '책', '도서', '교재', '인강', '클래스', '교육'],
    '패션/미용': ['옷', '신발', '가방', '미용실', '헤어', '화장품', '올리브영', '네일', '피부과', '쇼핑'],
    '업무': ['업무', '비즈니스', '미팅', '출장', '접대', '사무용품', '소모품'],
    '문화/취미': ['영화', '공연', '전시', '취미', '게임', '운동', '헬스', '수영', '볼링'],
    '종교/기부': ['봉헌', '헌금', '성당', '교회', '절', '기부', '후원'],
    '생필품': ['마트', '편의점', '생필품', '세제', '휴지', '샴푸', '비누', '치약', '다이소'],
...
응답은 반드시 위 카테고리 중 하나만 정확히 답해주세요. 다른 설명 없이 카테고리 이름만 출력하세요.`
        ...
        const validCategories: ExpenseCategory[] = [
            '커피/음료', '식사', '간식', '교통', '통신', '교육', '패션/미용', '업무', '문화/취미', '종교/기부', '생필품', '공간 사용료', '기타'
        ];
