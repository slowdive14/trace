                ...
                <div className="max-w-md mx-auto flex flex-col h-full gap-2">
                    ...
                    <div className="flex items-center gap-2 h-full">
                        <textarea
                            ...
                            className="flex-1 bg-bg-tertiary text-text-primary rounded-lg p-3 resize-none focus:outline-none focus:ring-1 focus:ring-accent min-h-[44px] max-h-[120px] overflow-y-auto"
                            rows={1}
                        />
                        <button
